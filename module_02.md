...
In this section we briefly describe how TensorFlow works on a lower level. This should help us to understand why we do certain things in our code.
...
### How TensorFlow Works - Very Simple

TensorFlow has two main parts:

1. **Graph** = Plan  
   A graph is like a drawing or plan. It shows what to calculate and in what order. No calculation happens here. Nothing is saved or executed yet.  
   *Think of it like writing a recipe, not cooking.*

2. **Session** = Do the work  
   A session is what runs the plan (graph). It gives the computer memory and power. It actually does the calculations.  
   *Think of it like cooking using the recipe.*

#### Simple Example

- Graph: "Add 5 and 3"
- Session: Actually calculate → 8

Without a session, TensorFlow will not calculate anything.

#### Why we need both

- Graph helps TensorFlow understand what to do
- Session helps TensorFlow do it

#### One-line memory tip (for exams)

- Graph → defines what to compute
- Session → executes the computation
...
Before we go too far, I will mention that there are different types of tensors. These are the most used and we will talk more in depth about each as they are used.
- Variable
- Constant
- Placeholder
- SparseTensor
